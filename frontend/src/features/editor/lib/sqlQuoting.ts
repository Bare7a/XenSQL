...
export const ALIAS_STOP_WORDS = new Set([
  'on', 'and', 'or', 'where', 'join', 'inner', 'left', 'right', 'full', 'cross', 'natural',
  'as', 'set', 'order', 'group', 'by', 'having', 'limit', 'offset', 'union', 'into', 'values',
  'select', 'from', 'using', 'lateral',
]);
...
export const QUOTE_FORCING_KEYWORDS = new Set([
  ...ALIAS_STOP_WORDS,
  'table', 'column', 'user', 'index', 'view', 'key', 'primary', 'foreign', 'references',
  'constraint', 'default', 'check', 'unique', 'create', 'drop', 'alter', 'insert', 'update',
  'delete', 'truncate', 'grant', 'revoke', 'case', 'when', 'then', 'else', 'end', 'null',
  'true', 'false', 'not', 'is', 'in', 'like', 'between', 'exists', 'distinct', 'all', 'any',
  'asc', 'desc', 'with', 'recursive', 'returning', 'cast', 'collate',
]);
