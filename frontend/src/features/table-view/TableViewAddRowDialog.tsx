...
function FieldValueInput({
  ...
  const autoGeneratedPlaceholder = defaultHint ? defaultHint : t('tableView.addRowDialog.autoGenerated');
          ...
          <>
            ...
            <div className="table-view-add-row-fields">
              {columns.map((col) => {
                ...
                const showBadges = col.isPrimary || col.isForeign || requiresInsertValue(col, driver);
                    ...
                    <div className="table-view-add-row-field-head">
                      ...
                      <div className="table-view-add-row-field-head-end">
                        ...
                        {showModePicker && (
                          ...
                          >
                            {showDefault && <option value="default">{t('tableView.addRowDialog.modeDefault')}</option>}
